...
urlpatterns = [
    ...
    url(r'^person/(?P<person_id>[0-9]+)/position/add/$', views.position, {'position_id': None}, name='add-position'),
    url(r'^person/(?P<person_id>[0-9]+)/position/(?P<position_id>[0-9]+)/edit/$', views.position, name='edit-position'),
