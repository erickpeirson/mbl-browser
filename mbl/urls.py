...
urlpatterns = [
    ...
    url(r'^person/(?P<person_id>[0-9]+)/edit/$', views.handle_person, name="edit-person"),
    ...
    url(r'^person/add/$', views.handle_person, name="add-person"),
    ...
    url(r'^person/(?P<person_id>[0-9]+)/affiliation/(?P<affiliation_id>[0-9]+)/edit/$', views.edit_affiliation, name='edit-affiliation'),
    url(r'^person/(?P<person_id>[0-9]+)/affiliation/(?P<affiliation_id>[0-9]+)/delete/$', views.delete_affiliation_record, name='delete-affiliation'),
    url(r'^person/(?P<person_id>[0-9]+)/position(?:/(?P<position_id>[0-9]+))?/$', views.position, name='position'),
